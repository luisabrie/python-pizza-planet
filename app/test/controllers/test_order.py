...
def __create_sizes_and_ingredients(sizes: list, ingredients: list, beverages:list):
    ...
    return created_sizes, created_ingredients, created_beverages


def test_create(app, beverages, ingredients, size, client_data):
    created_sizes, created_ingredients, created_beverages = __create_sizes_and_ingredients([size], ingredients, beverages)
    order = __order(created_ingredients, created_beverages, created_sizes.pop(),  client_data)
...
def test_get_all(app, ingredients, beverages, size, client_data):
    created_sizes, created_ingredients, created_beverages = __create_sizes_and_ingredients([size], ingredients, beverages)
    created_orders = []
    for _ in range(5):
